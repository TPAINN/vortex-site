...
interface AmbientBackgroundProps {
  /** intensity of the glow layers (0–1) */
  intensity?: number;
...
/**
 * A premium layered ambient background:
 *  - two counter-rotating conic "vortex" glows
 *  - drifting violet/blue/green radial orbs
 *  - a faint dot grid
 *  - drifting particles
 *  - a top vignette
 * Used by both the splash screen and the landing page hero.
 */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 80% at 50% -10%, oklch(0.14 0.04 292 / 0.9), transparent 60%), linear-gradient(180deg, oklch(0.05 0.01 290) 0%, var(--vortex-black) 55%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 100% at 50% 0%, transparent 55%, oklch(0.04 0.006 290 / 0.85) 100%)",
        }}
      />
    </div>
  );
