...
type BrandIcon = (props: IconProps) => JSX.Element;
...
const PLATFORMS: Platform[] = [
  { name: "YouTube", icon: YouTubeIcon, color: "#ff0000", note: "1080p · MP3" },
  { name: "TikTok", icon: TikTokIcon, color: "#25f4ee", note: "no watermark" },
  { name: "Instagram", icon: InstagramIcon, color: "#e1306c", note: "reels · stories" },
...
export default function Platforms() {
  return (
    <section id="platforms" className="relative px-4 py-24 sm:py-28">
      <div className="mx-auto w-[min(1120px,100%)]">
        ...
        <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4">
          {PLATFORMS.map((p, i) => (
            <Reveal key={p.name} delay={(i % 4) * 0.06} y={20}>
