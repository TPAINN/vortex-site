...
/**
 * A premium custom cursor: a small dot + a larger trailing ring.
 * The cursor elements always render off-screen and only become
 * visible once a mouse moves (touch devices never fire mousemove,
 * so they stay invisible). Hidden on small screens via CSS.
 */
