...
/** The Vortex mark: two concentric gradient rings, the inner one dashed. */
export function VortexLogo({ size = 28, className, animated = false }: VortexLogoProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle
        ...
        style={
          animated
            ? { transformOrigin: "50px 50px", animation: "vortex-spin 8s linear infinite" }
            : undefined
        }
      />
      <circle
