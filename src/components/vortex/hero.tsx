...
interface HeroProps {
  /** Only animate content in once the splash has fully exited. */
  active: boolean;
}
...
export default function Hero({ active }: HeroProps) {
  ...
  // parallax: background drifts down slower than content, content fades up
      ...
      >
        ...
        >
          {[...PLATFORMS, ...PLATFORMS].map((p, i) => (
            <span key={i} className="flex items-center gap-8 whitespace-nowrap sm:gap-11">
